            ...
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <p class="mb-0">
                            uibirzhasi.kz - созданная впервые мире биржа недвижимости, биржа встречных цен, цен продаж
                            недвижимости и цен покупок недвижимости.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-7">
                    <div class="intro-content" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <p class="lead-text">Ежедневно в 00.00 Астаны цены продаж недвижимости снижаются на 1%, а цены
                            покупок недвижимости повышаются на 1%. При совпадении основных характеристик недвижимости и цен
                            с точностью до 2% продавцу и покупателю высылаются уведомления по ватсапу. В уведомлении будет
                            указано что есть контрагент за номером таким то с ценой такой то, являющейся арифметической
                            средней между ценами продавца и покупателя, которые отличаются максимум на 2%. Получив
                            уведомление продавец или покупатель может посмотреь контактные данные контрагента внеся 1% от
                            стоимости недвижимости указанной в уведомлении на депозит на счет ТОО "СРА", являющийся
                            владельцем данного сайта. В случае срыва сделки депозит возвращается вносителю.</p>
                        <p>uibirzhasi.kz - созданная впервые мире биржа недвижимости, биржа встречных цен, цен продаж
                            недвижимости и цен покупок недвижимости.</p>

                        <div class="founder-highlight" data-aos="fade-up" data-aos-delay="300">
                            <div class="founder-image">
                                <img src="{{ asset('assets/img/person/person-m-7.webp') }}" alt="Founder"
                                    class="img-fluid">
                            </div>
                            <div class="founder-info">
                                <blockquote>uibirzhasi.kz - созданная впервые мире биржа недвижимости, биржа встречных цен,
                                    цен продаж недвижимости и цен покупок недвижимости.</blockquote>
                ...
                <div class="col-lg-5">
                    <div class="visual-section" data-aos="fade-left" data-aos-delay="250">
                        <div class="main-image">
                            <img src="{{asset("assets/img/real-estate/property-exterior-7.webp")}}" alt="Luxury Development"
                                class="img-fluid">
                        ...
                        <div class="overlay-image">
                            <img src="{{ asset('assets/img/real-estate/property-interior-6.webp') }}" alt="Interior Design"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
