                ...
                <div class="col-lg-8">
                    ...
                    @if ($listing->photos->count())
                        <div class="main-image mb-3 text-center">
                            <img id="main-photo" src="{{ asset($listing->photos->first()->url) }}"
                                class="img-fluid rounded shadow-sm"
                                style="object-fit: cover; width: 100%; max-height: 500px;" alt="Основное фото">
                        </div>
                        ...
                        @if ($listing->photos->count() > 1)
                            <div class="thumbnail-gallery d-flex flex-wrap gap-2 justify-content-center mb-3">
                                @foreach ($listing->photos as $photo)
                                    <img src="{{ asset($photo->url) }}" class="img-thumbnail"
                    ...
                    @else
                        <div class="main-image mb-3 text-center">
                            <img src="{{ asset('images/no-image.png') }}" class="img-fluid rounded shadow-sm"
                                style="object-fit: cover; width: 100%; max-height: 500px;" alt="Фото отсутствует">
                        </div>
                    @endif
                            ...
                            @else
                                ...
                                @php
                                    $searchQuery = collect([
                                        ...
                                        ->implode(', ');
                                @endphp
                                <iframe src="https://maps.google.com/maps?q={{ urlencode($searchQuery) }}&output=embed"
                    ...
                    <div class="property-overview sticky-top" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="agent-info">
                            ...
                            <div class="agent-details">
                                <h4>{{ $userName }}</h4>
                                <p class="text-muted small">Контакты будут доступны после внесения депозита</p>
                            </div>
                        </div>
