                ...
                <div class="col-md-4">
                    <div class="card border-0 rounded-4 shadow-sm h-100 text-center p-4">
                        <div class="mb-3 d-flex justify-content-center gap-3">
                            <div class="border rounded-3 px-3 py-2 fw-bold text-dark" style="font-size: 15px;">VISA</div>
                            <div class="border rounded-3 px-3 py-2 fw-bold text-dark" style="font-size: 15px;">Mastercard</div>
                        </div>
